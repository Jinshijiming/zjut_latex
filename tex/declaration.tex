...
{ 
    ...
    作者签名：\hfill 日期：\defSubmitYear 年\defSubmitMonth 月 \hspace*{6em}
    ...
    导师签名：\hfill 日期：\defSubmitYear 年\defSubmitMonth 月 \hspace*{6em}
    ...
    \begin{tabular*}{0.88\hsize}{@{\extracolsep{\fill}}l b{3.6cm} c l b{3.8cm}}   %   这里面的@什么意思
        ...
        申请学位 &  \defAcademic\defDegree  &	&    第二导师 & 
    ...
    {\centering
        ...
        {	
            \begin{tabular*}{0.8\hsize}{@{\extracolsep{\fill}}ccc c ccc}   %   这里面的@什么意思
                %\hline
                \hspace{1.0cm} 答辩日期：        & \defDefenseYear      &  年   &       \defDefenseMonth  &     月      & \defDefenseDay &     日\hspace{1.8cm}       \\ %\hline
            \end{tabular*}	\\
        }
    }
